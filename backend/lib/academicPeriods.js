...
function isDateWithinPeriod(now, startDate, endDate) {
...
function findActivePeriodIndexByDate(rows, now = new Date()) {
...
function applySystemActivePeriod(periods, now = new Date()) {
